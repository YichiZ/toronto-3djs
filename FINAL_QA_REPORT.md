...
- `maple-leaf-square-e` — Shared podium with the public square and its outdoor screen faces the arena.
...
- `l-tower` — Daniel Libeskind curve; reconstructed here as a tapered slab.
