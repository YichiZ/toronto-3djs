...
import { push, CLEARANCE, AHEAD, PUSH_RATE } from '../src/systems/vehiclePush.js';

// A sedan heading grid-east along z = 0. Its right-hand normal is (0, +1) = +Z.
const EAST = { x: 0, z: 0, dx: 1, dz: 0, half: 2.25, halfWidth: 0.93 };
...
test('a car heading grid-north pushes along X', () => {
  const north = { x: 0, z: 0, dx: 0, dz: -1, half: 2.25, halfWidth: 0.93 };
